...
import { InstagramEmbedData } from "@/types/embed.types";
...
export default function InstagramEmbed({
  ...
  const { postId, captioned = true } = data;
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    // Carrega o script do Instagram apenas se ainda não estiver carregado
    if (!document.getElementById("instagram-embed-script")) {
      ...
      // Se o script já estiver carregado, força o processamento dos embeds
        ...
        <div style={{ padding: "16px" }}>
          ...
          >
            <a
              ...
              rel="noreferrer"
            >
              Uma publicação partilhada por @instagram
            </a>
          </p>
        </div>
      </blockquote>
